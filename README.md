...
<param ve-map-layer geojson active title="Heliconia aurea (magenta)" url="https://github.com/JSTOR-Labs/plant-humanities/blob/main/data/heliconia-aurea.tsv" fill="#D11141" radius="6">  
