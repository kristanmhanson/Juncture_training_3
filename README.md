...
Custom GeoJSON files for certain countries and regions can be found on GitHub [glynnbird/countriesgeojson.](https://github.com/glynnbird/countriesgeojson) But, in some cases, you will need to create your own using [geojson.io.](https://geojson.io) New Guinea is a good case in point.
<param ve-map center="-17.553, 133.5403" zoom="3">
